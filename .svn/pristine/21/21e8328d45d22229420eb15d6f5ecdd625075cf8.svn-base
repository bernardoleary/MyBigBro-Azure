...
namespace UnitTests.Infostructure.MyBigBro.BusinessLogic
{
    ...
    public class TestGeoMarkerService
    {
        ...
        //private Mock<IDevice> device1 = null;
        //private Mock<IDevice> device2 = null;
        ...
        [Test]
        public void TestGetCountOfMarkersWithImage()
        {
            // arrange
            var deviceName1 = "test1";
            var deviceName2 = "test2";
            var deviceName3 = "nothing";

            // act
            var result1 = geoMarkerService.GetCountOfMarkersWithImage(deviceName1);
            var result2 = geoMarkerService.GetCountOfMarkersWithImage(deviceName2);
            var result3 = geoMarkerService.GetCountOfMarkersWithImage(deviceName3);
