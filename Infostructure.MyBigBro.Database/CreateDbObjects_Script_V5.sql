...
GO
/****** Object:  Table [dbo].[User]    Script Date: 01/05/2014 14:46:02 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
SET ANSI_PADDING OFF
GO
/****** Object:  Table [dbo].[GeoMarker]    Script Date: 01/05/2014 14:45:44 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
ALTER TABLE [dbo].[GeoMarker]  WITH CHECK ADD  CONSTRAINT [FK_GeoMarker_User] FOREIGN KEY([UserId])
REFERENCES [dbo].[User] ([Id])
GO
ALTER TABLE [dbo].[GeoMarker] CHECK CONSTRAINT [FK_GeoMarker_User]
GO
