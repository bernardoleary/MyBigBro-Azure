...
namespace Infostructure.MyBigBro.BusinessLogic.Tests.UnitTests
{
    ...
    public class TestLocation
    {
        ...
        public void TestIsPointWithinWebCamRadiusOfVisibility()
        {
            ...
            mockRepository.Setup(x => x.Set<Infostructure.MyBigBro.DataModel.Models.WebCam>()).Returns(new List<Infostructure.MyBigBro.DataModel.Models.WebCam>()
            {
                new Infostructure.MyBigBro.DataModel.Models.WebCam() {Id = 0, Name = "bernard", XCoord = 2, YCoord = 2, RadiusOfVisibility = 3},
                new Infostructure.MyBigBro.DataModel.Models.WebCam() {Id = 2, Name = "bernard2", XCoord = 8, YCoord = 8, RadiusOfVisibility = 7}
            }.AsQueryable());
